        <div class="contructer_order_details">
            <div class="out_order_details">
                <div class="order_managenment_code">
                    <p>Quản lý đơn hàng:<span>Chi tiết đơn hàng #10190</span></p>
                </div>
                <a href="">
                            ...
                            <table class="table_mmo">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p>quần làm ống xuông dứng 2020</p>
                                            <span>xanh</span>
                                        </td>
                                        <td>
                                            2
                                    ...
                                    <div class="btn_confirm">
                                        <div>
                                            <select name="" id="">
                                                ...
                                                <option value="">Xác nhận đơn</option>
                                                <option value="">Giao hàng</option>
                                                <option value="">Giao hàng thành công</option>
                                                <option value="">Giao Hàng Thất bại</option>
                                            </select>
                                        </div>
                                        <button type="submit">
                                            Cập nhật
                ...
                <div class="Related_information">
                    <div class="delivery_address">
                        ...
                        <div class="body_delivery_address">
                            <p>Số 160 đường mỹ đình hà nội</p>
                        </div>
                    </div>
